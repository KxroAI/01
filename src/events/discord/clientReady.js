...
import syncEmojis from "../../feedback/syncEmojis.js";
...
export default {
  ...
  async execute({ client }) {
    ...
    // Sync feedback emojis to the application on startup
    try {
      await syncEmojis(config.token);
    } catch (err) {
      logger.warn("EmojiSync", "Emoji sync failed (non-fatal)", err.message);
    }
